...
export default function QuizDetails() {
    ...
    const quiz = db.default.quizzes.find((quiz: any) => quiz._id === qid);
    return !quiz ? <div>No quiz found!</div> : (
        <div id="wd-quiz-details-page">
            <div className="d-flex justify-content-center mb-4">
                <Link to={`/Kanbas/Courses/${cid}/quizzes/${qid}/preview`} className="btn btn-secondary me-2">Preview</Link>
                <Link to={`/Kanbas/Courses/${cid}/quizzes/${qid}/edit`} className="btn btn-secondary"><QuizEditorButton /></Link>
            </div>

            <hr />

            <h2 id="wd-quiz-title" className="mb-4">{quiz.title}</h2>
            ...
            <table className="table table-borderless" style={{ width: "33%" }}>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="text-start">{quiz.timeLimitInMinutes ? `${quiz.timeLimitInMinutes} Minutes` : "Unknown"}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td className="text-start">{quiz.showCorrectAnswers ?? "Unknown"}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td className="fw-bold text-end">Require Respondus LockDown Browser</td>
                        <td className="text-start">{quiz.requireLockdownBrowser ? "Yes" : "No"}</td>
                    </tr>
                    <tr>
                        <td className="fw-bold text-end">Required to View Quiz Results</td>
                        <td className="text-start">{quiz.requireToViewResults ? "Yes" : "No"}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td className="text-start">{quiz.lockAfterAnswering ? "Yes" : "No"}</td>
                    </tr>
                </tbody>
            </table>
